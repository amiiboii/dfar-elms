...
export const modules: Module[] = [
  {
    ...
    progress: 65,
    lessons: [
      { id: "l1", title: "Introduction to Maritime Safety", titleSi: "සමුද්‍ර ආරක්ෂාව හැඳින්වීම", titleTa: "கடல் பாதுகாப்பு அறிமுகம்", type: "video", duration: "25:00", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", completed: true },
      { id: "l2", title: "Safety Equipment & Life Jackets", titleSi: "ආරක්ෂක උපකරණ සහ ජීවිත කබා", titleTa: "பாதுகாப்பு உபகரணங்கள் & உயிர் காப்பு ஜாக்கெட்கள்", type: "video", duration: "30:00", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", completed: true },
      { id: "l3", title: "Emergency Procedures at Sea", titleSi: "මුහුදේ හදිසි ක්‍රියා පටිපාටි", titleTa: "கடலில் அவசர நடைமுறைகள்", type: "video", duration: "35:00", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", completed: true },
      ...
      { id: "l7", title: "Communication at Sea - VHF Radio", titleSi: "මුහුදේ සන්නිවේදනය - VHF රේඩියෝ", titleTa: "கடலில் தொடர்பு - VHF ரேடியோ", type: "video", duration: "28:00", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", completed: true },
      { id: "l8", title: "First Aid at Sea", titleSi: "මුහුදේ ප්‍රථමාධාර", titleTa: "கடலில் முதலுதவி", type: "video", duration: "32:00", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", completed: false },
      ...
      { id: "l11", title: "Rescue Operations & Coordination", titleSi: "ගලවා ගැනීමේ මෙහෙයුම් සහ සම්බන්ධීකරණය", titleTa: "மீட்பு நடவடிக்கைகள் & ஒருங்கிணைப்பு", type: "video", duration: "30:00", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", completed: false },
  ...
  },
  {
    ...
    progress: 25,
    lessons: [
      { id: "l1", title: "Why Sustainable Fishing Matters", titleSi: "තිරසාර ධීවරය වැදගත් වන්නේ ඇයි?", titleTa: "நிலையான மீன்பிடி ஏன் முக்கியம்", type: "video", duration: "22:00", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", completed: true },
      { id: "l2", title: "Fishing Gear & Methods", titleSi: "ධීවර උපකරණ සහ ක්‍රම", titleTa: "மீன்பிடி கருவிகள் & முறைகள்", type: "video", duration: "28:00", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", completed: true },
      ...
      { id: "l5", title: "Bycatch Reduction Techniques", titleSi: "අතුරු ධීවර අවම කිරීමේ ක්‍රම", titleTa: "இணைப்பிடிப்பு குறைப்பு நுட்பங்கள்", type: "video", duration: "24:00", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", completed: false },
  ...
  },
  {
    ...
    progress: 0,
    lessons: [
      { id: "l1", title: "Licensing Requirements Overview", titleSi: "බලපත්‍ර අවශ්‍යතා දළ විසුරුම", titleTa: "உரிமத் தேவைகள் மேலோட்டம்", type: "video", duration: "20:00", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", completed: false },
  ...
  },
  {
    ...
    progress: 100,
    lessons: [
      { id: "l1", title: "Introduction to Fish Processing", titleSi: "මත්ස්‍ය සැකසුම හැඳින්වීම", titleTa: "மீன் பதப்படுத்தல் அறிமுகம்", type: "video", duration: "22:00", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", completed: true },
    ],
  ...
  },
  {
    ...
    progress: 40,
    lessons: [
      { id: "l1", title: "Sri Lanka's Marine Biodiversity", titleSi: "ශ්‍රී ලංකාවේ සමුද්‍ර ජෛව විවිධත්වය", titleTa: "இலங்கையின் கடல் உயிர்ப்பன்மை", type: "video", duration: "30:00", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", completed: true },
      { id: "l2", title: "Coral Reef Protection", titleSi: "කොරල්පර ආරක්ෂණය", titleTa: "பவளப்பாறை பாதுகாப்பு", type: "video", duration: "25:00", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", completed: true },
  ...
  },
  {
    ...
    progress: 80,
    lessons: [
      { id: "l1", title: "Understanding Weather Patterns", titleSi: "කාලගුණ රටා අවබෝධ කර ගැනීම", titleTa: "வானிலை அமைப்புகளைப் புரிந்துகொள்ளுதல்", type: "video", duration: "28:00", videoUrl: "https://www.youtube.com/embed/dQw4w9WgXcQ", completed: true },
