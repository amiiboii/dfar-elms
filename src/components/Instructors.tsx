...
const instructors = [
  { name: "Dr. Kumara Perera", role: "Marine Biology Expert", students: "2.4k+", image: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=300&q=80" },
  { name: "Prof. Nimal Fernando", role: "Fisheries Management", students: "3.1k+", image: "https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=300&q=80" },
  { name: "Mrs. Chamari Silva", role: "Aquaculture Specialist", students: "1.8k+", image: "https://images.unsplash.com/photo-1580489944761-15a19d654956?w=300&q=80" },
  { name: "Mr. Ranjith Bandara", role: "Navigation & Safety Officer", students: "4.2k+", image: "https://images.unsplash.com/photo-1500648767791-00dcc994a43e?w=300&q=80" },
];
      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-primary-dark mb-3">
            {t("expert_instructors")}
          </h2>
          <p className="text-gray-mid max-w-2xl mx-auto">
            {t("expert_instructors_desc")}
          </p>
        </div>
          ...
          {instructors.map((inst) => (
            <div key={inst.name} className="group text-center">
              ...
              <p className="text-sm text-gray-mid mt-1">
                <i className="fa-solid fa-user-graduate mr-1" /> {inst.students} {t("students")}
              </p>
            </div>
          ))}
        </div>
        ...
        <div className="text-center mt-10">
          <a href="/modules" className="inline-flex items-center gap-2 border-2 border-primary text-primary font-semibold px-8 py-3 rounded-lg hover:bg-primary hover:text-white transition">
            {t("view_all_instructors")} <i className="fa-solid fa-arrow-right" />
          </a>
        </div>
      </div>
    </section>
